...
_ITM_abortTransaction (_ITM_abortReason abortReason) ITM_REGPARM ITM_PURE;

extern void _ITM_finalizeThread() ITM_REGPARM;
...
#endif /* i386 */
#undef ITM_BARRIERS
#undef ITM_REQUIRED_BARRIERS

void _ITM_incrementRequiredReads(void* ptr UNUSED) ITM_REGPARM ITM_PURE;
void _ITM_incrementRequiredWrites(void* ptr UNUSED) ITM_REGPARM ITM_PURE;

// ABI Section 5.13
extern void _ITM_memcpy (void *, const void *, size_t) ITM_REGPARM;
...
// ABI Section 5.14
extern void _ITM_memmove (void *, const void *, size_t) ITM_REGPARM;
...
// ABI Section 5.15
extern void _ITM_memset (void *, int, size_t) ITM_REGPARM;
